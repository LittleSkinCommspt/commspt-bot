...
SimpleReply('bakaxl.latest', [Plain(tF.bakaxl_latest)])
SimpleReply('pcl.latest', [Plain(tF.pcl_latest)])
SimpleReply('manual', [
...
SimpleReply('csl.config', [Plain(tF.csl_config_littleskin)])
SimpleReply('clfcsl', [Plain(tF.clfcsl)])
SimpleReply('csl.latest', [Plain(tF.csl_latest)])
...
SimpleReply('network', [Plain(tF.network)])
