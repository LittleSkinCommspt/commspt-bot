class TextFields(object):
    ...
    manual = '请仔细阅读 LittleSkin 用户使用手册！\nhttps://manual.littlesk.in/'
    faq = '你也许可以在「常见问题解答」中找到答案\nhttps://manual.littlesk.in/faq.html'
    ot = '请勿再次讨论无关话题，否则会被管理员禁言！\n如您是在 LittleSkin 官方交流群收到此警告，请前往 Honoka Café 继续您的闲聊话题。群号 651672723'
    ...
    csl_log = 'CustomSkinLoader 的日志位于 .minecraft/CustomSkinLoader/CustomSkinLoader.log，请将此文件直接上传至 https://pastebin.aosc.io/\n在提交后，请将网址发送至群内'
...
更多：https://manual.littlesk.in/advanced/yggdrasil.html'''
    ...
    csl_log_parsing = 'Got it! I am busy with parsing it now!'
    class ban(object):
        add_succ = '因滥用而被封禁'
        add_fail = '已在封禁列表中'
        remove_succ = '已被解除封禁'
